...
class GenixerShikraConfig(LlamaConfig):
    model_type = "Genixer_shikra"


class GenixerShikraLlamaModel(LlamaModel):
    config_class = GenixerShikraConfig

    def __init__(self, config: LlamaConfig, mm_vision_tower=None, mm_hidden_size=None):
        super(GenixerShikraLlamaModel, self).__init__(config)
    ...
    def forward(
        ...
        return super(GenixerShikraLlamaModel, self).forward(
...
class GenixerShikraLlamaForCausalLM(LlamaForCausalLM):
    config_class = GenixerShikraConfig

    def __init__(self, config: GenixerShikraConfig):
        super(LlamaForCausalLM, self).__init__(config)
        self.model = GenixerShikraLlamaModel(config)
